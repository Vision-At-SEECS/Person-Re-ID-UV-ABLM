...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, in_chans=3,
        ...
        self.adl_drop_rate = 0.75    # default is 0.75
        self.adl_threshold = 0.8
    ...
    #    self.fc = self.fc.append(ADL(self.adl_drop_rate, self.adl_threshold))        # added by nazia for ADL
...
def resnet50d(pretrained=False, **kwargs):
    ...
    """
    model_args = dict(
        block=Bottleneck, layers=[3, 4, 6, 3], stem_width=32, stem_type='deep', avg_down=True, **kwargs)   # avg_down=True, stem_type='deep'
